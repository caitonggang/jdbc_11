...
//			return ps.execute();
    ...
    public void queryWithIDCardOrExamCard(){
        ...
        if("a".equalsIgnoreCase(selection)) {//if(selection.equalsIgnoreCase("a")){
            ...
            String examCard =scanner.next();
            String sql = "select FlowID flowID,Type,IDCard,ExamCard,StudentName,Location,Grade grade from examstudent where examCard = ?";
            ...
            String IDCard =scanner.next();
            String sql = "select FlowID flowID,Type,IDCard,ExamCard,StudentName,Location,Grade grade from examstudent where IDCard = ?";
